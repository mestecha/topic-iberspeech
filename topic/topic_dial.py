...
df_amazon_dial = pd.read_csv('data/df_amazon_dial.csv')
...
start = time.time()
dial_topic_1, dial_topic_score_1 = [], []
dial_topic_2, dial_topic_score_2 = [], []
dial_topic_3, dial_topic_score_3 = [], []
dial_subtopic_1, dial_subtopic_score_1 = [], []
dial_subtopic_2, dial_subtopic_score_2 = [], []
dial_subtopic_3, dial_subtopic_score_3 = [], []
dial_topic_amazon, dial_topic_amazon_score  = [], []
dial_topic_amazon_uncased, dial_topic_amazon_uncased_score  = [], []
hypothesis = 'The topic of this sentence is {}.'

for dial in tqdm(df_amazon_dial['DIAL']):
    utterance = {'text': [dial]}

    # First level
    CANDIDATE_LABELS = candidate_labels_first_level
    topic, topic_score = handle_message(utterance, CANDIDATE_LABELS, hypothesis)
    dial_topic_1.append(topic)
    dial_topic_score_1.append(topic_score)
    ...
    dial_subtopic_1.append(subtopic)
    dial_subtopic_score_1.append(subtopic_score)

    # Second level
    CANDIDATE_LABELS = candidate_labels_second_level
    topic, topic_score = handle_message(utterance, CANDIDATE_LABELS, hypothesis)
    dial_topic_2.append(topic)
    dial_topic_score_2.append(topic_score)
    ...
    if candidate_labels_subtopic:
        ...
        subtopic, subtopic_score = topic, 0
    dial_subtopic_2.append(subtopic)
    dial_subtopic_score_2.append(subtopic_score)

    # Third level
    CANDIDATE_LABELS = candidate_labels_third_level
    topic, topic_score = handle_message(utterance, CANDIDATE_LABELS, hypothesis)
    dial_topic_3.append(topic)
    dial_topic_score_3.append(topic_score)
    ...
    if candidate_labels_subtopic:
        ...
        subtopic, subtopic_score = topic, 0
    dial_subtopic_3.append(subtopic)
    dial_subtopic_score_3.append(subtopic_score)

    # Amazon
    CANDIDATE_LABELS = candidate_labels_amazon
    topic, topic_score = handle_message(utterance, CANDIDATE_LABELS, hypothesis)
    dial_topic_amazon.append(topic)
    dial_topic_amazon_score.append(topic_score)

    # Amazon uncased
    CANDIDATE_LABELS = candidate_labels_amazon_uncased
    topic, topic_score = handle_message(utterance, CANDIDATE_LABELS, hypothesis)
    dial_topic_amazon_uncased.append(topic)
    dial_topic_amazon_uncased_score.append(topic_score)

df_amazon_dial['TOPIC_IS_1'] = dial_topic_1
df_amazon_dial['TOPIC_IS_SCORE_1'] = dial_topic_score_1
df_amazon_dial['SUBTOPIC_IS_1'] = dial_subtopic_1
df_amazon_dial['SUBTOPIC_IS_SCORE_1'] = dial_subtopic_score_1
df_amazon_dial['TOPIC_IS_2'] = dial_topic_2
df_amazon_dial['TOPIC_IS_SCORE_2'] = dial_topic_score_2
df_amazon_dial['SUBTOPIC_IS_2'] = dial_subtopic_2
df_amazon_dial['SUBTOPIC_IS_SCORE_2'] = dial_subtopic_score_2
df_amazon_dial['TOPIC_IS_3'] = dial_topic_3
df_amazon_dial['TOPIC_IS_SCORE_3'] = dial_topic_score_3
df_amazon_dial['SUBTOPIC_IS_3'] = dial_subtopic_3
df_amazon_dial['SUBTOPIC_IS_SCORE_3'] = dial_subtopic_score_3
df_amazon_dial['TOPIC_AMAZON_IS'] = dial_topic_amazon
df_amazon_dial['TOPIC_AMAZON_IS_SCORE'] = dial_topic_amazon_score
df_amazon_dial['TOPIC_AMAZON_UNCASED_IS'] = dial_topic_amazon_uncased
df_amazon_dial['TOPIC_AMAZON_UNCASED_IS_SCORE'] = dial_topic_amazon_uncased_score

end = time.time()
print(end-start)

logging.info('Saving Results')
df_amazon_dial.to_csv('results/df_amazon_dial_' + model_name_save + '_topics.csv', index=False)
